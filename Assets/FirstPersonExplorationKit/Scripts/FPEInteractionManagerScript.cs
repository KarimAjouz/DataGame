        ...
        void Update()
        {
            ...
            else if (currentInteractionState == eInteractionState.FREE)
            {
                ...
                if (currentHeldObject == null && currentJournal == null)
                {
                    ...
                    if (FPEInputManager.Instance.GetButtonDown(FPEInputManager.eFPEInput.FPE_INPUT_ZOOM) || b_Zoomed)
                    {
                        setMouseSensitivity(zoomedMouseSensitivity);
                    }
                    if (FPEInputManager.Instance.GetButtonUp(FPEInputManager.eFPEInput.FPE_INPUT_ZOOM) || (!b_Zoomed && cameraZoomedIn))
                    {
                        restorePreviousMouseSensitivity(false);
                    }
                    if (FPEInputManager.Instance.GetButton(FPEInputManager.eFPEInput.FPE_INPUT_ZOOM) || b_Zoomed)
                    {
                        cameraZoomedIn = true;
                    }
                    else
