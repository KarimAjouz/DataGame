...
namespace Whilefun.FPEKit
{
    ...
    public class FPEInputManager : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            // PC Interactions
            FPEVirtualAxes.Add(eFPEInput.KAZ_INPUT_SCROLLWHEEL, new FPEInputAxis(eFPEInput.KAZ_INPUT_SCROLLWHEEL, "Mouse Scrollwheel"));
        ...
        void Update()
        {
            ...
            {
                FPEVirtualAxes[eFPEInput.KAZ_INPUT_SCROLLWHEEL].Update(1.0f);
            }
            ...
            {
                FPEVirtualAxes[eFPEInput.KAZ_INPUT_SCROLLWHEEL].Update(0.0f);
            }
