...
{
    public class NDCreateMenu : Editor
    {
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        #region Input Field
        [MenuItem("GameObject/DreamOS/90s Add-on/Input Field/Standard")]
        ...
        #region Modal Window
        [MenuItem("GameObject/DreamOS/90s Add-on/Modal Window/Standard")]
        ...
        #region Scrollbar
        [MenuItem("GameObject/DreamOS/90s Add-on/Scrollbar/Horizontal")]
        static void ScrollbarHorizontal()
        {
            CreateObject("UI Elements/Scrollbar/Scrollbar Horizontal");
        }

        [MenuItem("GameObject/DreamOS/90s Add-on/Scrollbar/Vertical")]
        ...
        #region Selectors
        [MenuItem("GameObject/DreamOS/90s Add-on/Selectors/Horizontal Selector")]
        static void HorizontalSelector()
        {
            CreateObject("UI Elements/Selectors/Horizontal Selector");
        }

        [MenuItem("GameObject/DreamOS/90s Add-on/Selectors/Vertical Selector")]
        ...
        #region Slider
        [MenuItem("GameObject/DreamOS/90s Add-on/Slider/Standard")]
        static void Slider()
        {
        ...
        #region Switch
        [MenuItem("GameObject/DreamOS/90s Add-on/Switch/Standard")]
        static void Switch()
        {
        ...
        #region UIM
        [MenuItem("GameObject/DreamOS/90s Add-on/UI Manager/Image")]
        static void UIMImage()
        {
            CreateObject("UI Elements/UIM/Image");
        }

        [MenuItem("GameObject/DreamOS/90s Add-on/UI Manager/Text (TMP)")]
        static void UIMText()
        {
        ...
        #region Others
        [MenuItem("GameObject/DreamOS/90s Add-on/Others/Information Popup")]
